...
- SEO / e-commerce / WooCommerce / FIMM / migration / trafic organique / mots clés / architecture contenu / maillage interne / GSC / Yoast / SEMRush → {"panel":"seo","intro":"90 pages, 146 mots clés suivis, 3 phases de montée en position — l'architecture SEO FIMM reconstruite de A à Z."}
...
- Agent veille cyber / VPS / Gemini / cron / MCP / publication automatique / agent autonome → {"panel":"veilleagent","intro":"Un agent IA qui tourne en arrière-plan sur VPS — veille cyber, génération et publication d'articles sans intervention humaine."}
...
SEO & Architecture de contenu FIMM (fimm.fr) : reconstruction complète post-migration WooCommerce. 90 pages de catégories produites (9 silos × 3 niveaux hiérarchiques), specs vérifiées en live, format Yoast unifié. Audit technique 90 URLs par requêtes HEAD (63×200, 13 corrections slugs, 14 pages manquantes transmises agence). Maillage interne 3 axes : vertical, latéral, inter-silos. 10 guides /conseils/ intégrés aux descriptions. 6 mauvais atterrissages SEMRush corrigés. 35 mots clés priorisés en 3 phases (KD<15 / 15-25 / >25), 8 URLs soumises GSC. 146 mots clés suivis. Outils : SEMRush, GSC, Yoast SEO Premium, requêtes HEAD JS, sitemap XML.
...
Agent Veille Cyber autonome (VPS OVH) : agent IA déployé en production sur VPS OVH. Cerveau Gemini 2.5 Flash (gratuit dans les quotas). Cron automatique tous les 2 jours à 9h. MCP server connecté à louche-ou-pas.fr pour publication directe. Génère et publie des articles de veille cybersécurité sans intervention humaine. Pipeline image en cours (Nano Banana → Supabase → illustration auto). Démontre la capacité à déployer un vrai agent IA en production, pas un prototype.
